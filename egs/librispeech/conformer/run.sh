...
model_dir="$(basename "${asr_config}" .yaml)_${feats_type}_${lang}_${token_type}${tag}"
...
token_list=${feats_dir}/data/${lang}_token_list/bpe_unigram4000/tokens.txt
bpemodel=${feats_dir}/data/${lang}_token_list/bpe_unigram4000/bpe.model
echo "dictionary: ${token_list}, bpemodel: ${bpemodel}"
    ...
    for ((i = 0; i < $gpu_num; ++i)); do
        {
            ...
            asr_train.py \
                ...
                --train_shape_file ${feats_dir}/exp/asr_stats_${feats_type}_en_bpe4000/${train_set}/speech_shape \
                --train_shape_file ${feats_dir}/exp/asr_stats_${feats_type}_en_bpe4000/${train_set}/text_shape.bpe \
                ...
                --valid_shape_file ${feats_dir}/exp/asr_stats_${feats_type}_en_bpe4000/${valid_set}/speech_shape \
                --valid_shape_file ${feats_dir}/exp/asr_stats_${feats_type}_en_bpe4000/${valid_set}/text_shape.bpe  \
                --resume true \
