            ...
            if word in self.phone_map:
                ...
                for char in word:
                    if char in self.phone_map:
                        ...
                        phone2 = pypinyin.contrib.tone_convert.to_finals_tone3(phone, strict=False)
                        if phone1 == "":
...
if __name__ == '__main__':
    text2phone_tokenizer = NewText2Phone("text2phone_from_pinyin_dict.txt", use_alignment=True)
    # sentence = "讧长长久久"
    sentence = "我是谁长久最大楼市饿内讧红讧恶心"
    phone_seq, alignment_seq = text2phone_tokenizer.trans(sentence)
    print(phone_seq)
    print(alignment_seq)
