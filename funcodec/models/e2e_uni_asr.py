...
from funcodec.models.e2e_asr_common import ErrorCalculator
from funcodec.modules.nets_utils import th_accuracy
from funcodec.modules.add_sos_eos import add_sos_eos
from funcodec.losses.label_smoothing_loss import (
...
from funcodec.modules.streaming_utils.chunk_utilis import sequence_mask
from funcodec.models.predictor.cif import mae_loss
...
class UniASR(AbsESPnetModel):
    ...
    def __init__(
        ...
        if self.encoder.overlap_chunk_cls is not None:
            from funcodec.modules.streaming_utils.chunk_utilis import build_scama_mask_for_cross_attention_decoder
